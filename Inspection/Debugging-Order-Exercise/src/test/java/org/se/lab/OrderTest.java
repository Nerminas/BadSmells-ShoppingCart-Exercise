...
public class OrderTest
{
	...
	public void setup()
	{
		...
		order.addLine(new OrderLine(10, 4,
			new Product(20, "Effective Java: A Programming Language Guide", 3495)));
	...
	public void testOrderLines()
	{
		...
		Assert.assertEquals("Effective Java: A Programming Language Guide",
			lines.get(0).getProduct().getDesc());
	...
	public void testToString()
	{
		final String EXPECTED =
			"1,02.12.2013" + "[" + "10,4,20,Effective Java: A Programming Language Guide,3495, "
				+ "11,2,21,Hardcore Java,2870, " + "12,5,22,The Java Programming Language,4095"
				+ "]";
